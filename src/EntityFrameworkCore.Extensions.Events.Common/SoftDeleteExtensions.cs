...
namespace EntityFrameworkCore.Extensions.Events.Common
{
    public static class SoftDeleteExtensions
    {
        ...
        public static TEntity SoftDelete<TEntity>(this DbSet<TEntity> dbSet, object[] key) where TEntity : class, ISupportSoftDelete
        {
            var entity = dbSet.Find(key);
            return entity.SoftDelete();
        }
        
        public static TEntity SoftDelete<TEntity>(this DbContext context, object[] key) where TEntity : class, ISupportSoftDelete
        {
